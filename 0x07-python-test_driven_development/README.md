...
This Project was completed during **Full Stack Software Engineering studies** at **ALX_SE**. It aims to learn about docstrings to create and implement tests in **Python**.
