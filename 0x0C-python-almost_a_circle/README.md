# Almost a circle
This project was completed for **Full Stack Software Engineering** at **ALX_SE**. It aims to learn about unit testing, serialization, deserialization, JSON, `args` and `kwargs` in **Python**.
